...
const Footer: React.FC = () => {
  ...
  return (
    <footer className=" z-10 sticky bottom-0 right-0 flex  flex-col justify-center items-center   py-4   w-full    bg-[#EEEEEE]  ">
    
      <div className='my-2'>
        <ul className='flex justify-center  items-center space-x-4'>
          <li>
            <a
              href="https://www.facebook.com/debremehretdc"
              title="Facebook"
              target="_blank"
          ...
          <li>
            <a
              href="https://www.instagram.com/explore/tags/wordcamp/"
              title="Instagram"
              target="_blank"
              rel="noreferrer noopener"
